<script setup lang="ts">
  ...
  function syncOpenState() {
    ...
    const nodePath = findNodePathBySourceId(
      props.sourceGroups,
      activePath.value.sourceId,
    );
  ...
  function findNodePathBySourceId(
    nodes: DocsSourceGroup[],
    sourceId: string,
  ): string[] {
  ...
  <aside :class="['docs-sidebar', { 'docs-sidebar--open': isOpen }]">
    <div class="docs-sidebar__inner">
      <div class="docs-sidebar__heading">
        <p class="docs-sidebar__eyebrow">Navigation</p>
        <h2 class="docs-sidebar__title">目录</h2>
      </div>

      <div ref="sidebarInner" class="docs-sidebar__scroll scroll-shell">
